...
// const merged = [].concat.apply([], input)
 
// const g = merged.filter( idx =>{
  
//  const h = if(isNaN(idx) || idx % 5 === 0){ 
//  return idx;
//  }
...
let findShortest = (data) => {
  // Solution code here...
  const result = data.name.filter(word => word.length > 4);
  return result;
}
